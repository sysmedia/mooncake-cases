...
/**
 * Created by taochen on 2019-04-01.
 *
 * Note: For SirenLPR protocol verification, the remote endpoint GS has to disable the stereo.
 */
@CollectSutLogIfFailed
class AudioProtocolVerificationInSIPCall extends MoonCakeSystemTestSpec {
    @Shared
    ...
    @Unroll
    def "Verify Audio Protocol In SIP Call With Audio Protocol #expectedProtocol And In Call Rate #callRate Kbps"(AudioType protocol,
