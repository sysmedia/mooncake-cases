 ...
 * Manually swith to other provision server after DHCP 66 provisioning.
 */
class Auto_Provisioning_Server_Option_66_Server_Switch extends MoonCakeProvisionTestSpec {
    @Shared
    ...
    def "Verify if the MoonCake can be provisioned by the DHCP option 66 and can be switched to FTP provision mode"() {
        ...
        doCommandOnHttp(DHCP_SERVER, cmdFtpsSet66)
