 ...
 * DHCP 160 provisioning value is null, MoonCake will not be redirected to ztp.polycom.com for provisioning.
 */
class Auto_Provisioning_Server_Option_Custom_160_Failure extends MoonCakeProvisionTestSpec {
    def "Verify if the MoonCake cannot be provisioned by the DHCP option 160 with empty settings"() {
        ...
        doCommandOnHttp(DHCP_SERVER, cmdFtpSet160WithEmpty)
