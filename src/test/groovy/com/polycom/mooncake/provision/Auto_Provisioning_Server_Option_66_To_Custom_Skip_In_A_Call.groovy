 ...
 * MoonCake will skip reprovisioning even get new DHCP option when in a call.
 * MoonCake will do reprovisioning when it's not in a call.
 */
class Auto_Provisioning_Server_Option_66_To_Custom_Skip_In_A_Call extends MoonCakeProvisionTestSpec {
    @Shared
    ...
    def "Verify if the MoonCake skip provision by the DHCP option 66 when it is in a call"() {
