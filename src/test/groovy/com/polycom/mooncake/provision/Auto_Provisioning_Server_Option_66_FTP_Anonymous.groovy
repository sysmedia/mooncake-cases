 ...
 */
class Auto_Provisioning_Server_Option_66_FTP_Anonymous extends MoonCakeProvisionTestSpec {
    @Shared
    ...
    def "Verify if the MoonCake can be provisioned by the DHCP option 66 with anonymous FTP account"() {
        ...
        doCommandOnHttp(DHCP_SERVER, cmdFtpAnonymousSet66)
        ...
        doCommandOnHttp(DHCP_SERVER, cmdDel66)
        doCommandOnHttp(DHCP_SERVER, cmdDel160)
        doCommandOnHttp(DHCP_SERVER, cmdFtpsAnonymousSet66)
