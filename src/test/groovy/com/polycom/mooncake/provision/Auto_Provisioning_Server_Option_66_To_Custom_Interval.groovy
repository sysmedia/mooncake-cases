 ...
 * Debut will wait for provisioning interval to take new DHCP option from provisioning profile to do DHCP provision.
 */
class Auto_Provisioning_Server_Option_66_To_Custom_Interval extends MoonCakeProvisionTestSpec {
    @Shared
