 ...
 * Provision items: call setting call rate--different call rate when MoonCake as H323 callee.
 * <CallSettings>
 ...
 * </CallSettings>
 */
class FTP_Provisioning_Call_Settings_Network_Call_Rate_H323_Callee extends MoonCakeProvisionTestSpec {
    @Shared
    ...
    def "Verify if the MoonCake can be set the call rate with the FTP provision and can call with the remote endpoint with rate #callRate KBPS"(int callRate) {
        ...
        then: "GS place H323 call with the MoonCake"
        groupSeries.placeCall(mc_e164Num, CallType.H323, callRate)
