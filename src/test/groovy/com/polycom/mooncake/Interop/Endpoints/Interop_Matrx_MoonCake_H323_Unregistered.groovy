...
/**
 * This case is to verify the matrix testing by H.323 while both MoonCake are not registered to any
 * call server
 */

class Interop_Matrx_MoonCake_H323_Unregistered extends MoonCakeSystemTestSpec {
    @Shared
    MoonCake moonCake_1
    ...
    @Unroll
    def "Place call from MoonCake to MoonCake_1 with both H323 unregistered and call rate #CallRate Kbps"(int CallRate,
        ...
        then: "MoonCake place H323 call to MoonCake_1 and MoonCake mute video"
        logger.info("===============Start H323 Call with call rate " + CallRate + "===============")
        retry(times: 3, delay: 5) {
            moonCake.placeCall(moonCake_1.ip, CallType.H323, CallRate)
        }
    ...
    def "Place call from MoonCake to MoonCake_1 with both H323 registered and call rate 64 Kbps"() {
        ...
        retry(times: 3, delay: 5) {
            moonCake.placeCall(moonCake_1.ip, CallType.H323, 64)
        }
    ...
    def "Place call from MoonCake_1 to MoonCake with both H323 registered and call rate #CallRate Kbps"(int CallRate,
        ...
        retry(times: 3, delay: 5) {
            moonCake_1.placeCall(moonCake.ip, CallType.H323, CallRate)
        }
