...
/**
 * This case is to verify the matrix testing with RPD Windows by H.323 with various call rates.
 */

class Interop_Matrix_RPD_Win_H323 extends MoonCakeSystemTestSpec {
    @Shared
    RpdWin rpdWin
    ...
    @Unroll
    def "Place call from MoonCake to RPD Win with both H323 registered and call rate #CallRate Kbps"(int CallRate,
    ...
    @Unroll
    def "Place call from RPD Win to MoonCake with both H323 registered and call rate #CallRate Kbps"(int CallRate,
                                                                                                     String expectedProtocol,
                                                                                                     String expectedResolution_PVTX,
                                                                                                     String expectedResolution_CVTX,
                                                                                                     String expectedResolution_PVTX_Sending,
        ...
        then: "Set both MoonCake and RPD Win to H323 registered"
        moonCake.registerGk(true, false, dma.ip, mooncake_h323Name, mooncake_e164, "", "")
        rpdWin.registerH323(dma.ip, rpd_h323Name, rpd_e164)
        pauseTest(3)
        ...
        logger.info("===============Start H323 Call with call rate " + CallRate + "===============")
        retry(times: 3, delay: 5) {
            rpdWin.placeCall(mooncake_e164, CallType.H323, CallRate)
        }
