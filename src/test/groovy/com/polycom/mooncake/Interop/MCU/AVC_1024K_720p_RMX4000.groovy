 ...
 */
class AVC_1024K_720p_RMX4000 extends MoonCakeSystemTestSpec{
    @Shared
    Dma dma
    ...
    def "Verify MoonCake Can Join The H323 Conference With Call Rate 1024Kbps by dialing VMR#dialString"(String dialString,
                                                                                             int callRate) {
        setup:
        moonCake.hangUp()
        groupSeries.hangUp()
