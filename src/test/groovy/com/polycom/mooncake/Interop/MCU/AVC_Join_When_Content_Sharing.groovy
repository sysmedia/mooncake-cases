...
/**
 * Created by Gary Wang on 2019-06-13.
 *
 *This case is to verify MoonCake and other endpoints join AVC conference while there is content sharing
 *SUT joins conference and sends content, then FE joins conference
 *
 * Check audio, video,content
 * Test with H323 and SIP TCP
 */
class AVC_Join_When_Content_Sharing extends MoonCakeSystemTestSpec{
    @Shared
    Dma dma
