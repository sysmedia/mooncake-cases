 ...
 *
 * This case is to verify MoonCake calling NGB MCU via VMR with call rate 1024K
 *
 ...
 */
class AVC_1024K_720p_NGB extends MoonCakeSystemTestSpec{
    @Shared
    Dma dma
    ...
    def "Verify MoonCake Can Join The H323 Conference With Call Rate 1024Kbps by dialing VMR "(String dialString,
                                                                                             int callRate) {
        setup:
        moonCake.hangUp()
        groupSeries.hangUp()
        ...
        verifyMediaStatistics(MediaChannelType.ARX, "--:--:--:--:0:--")
        verifyMediaStatistics(MediaChannelType.ATX, "--:--:--:--:0:--")
        verifyMediaStatistics(MediaChannelType.PVRX, "H.264High:832x480:--:--:--:--")
        verifyMediaStatistics(MediaChannelType.PVTX, "H.264High:1280x720:--:--:--:--")
    ...
    def "Verify MoonCake Can Join The SIP Conference With Call Rate 1024Kbps by dialing VMR#dialString"(String dialString,
