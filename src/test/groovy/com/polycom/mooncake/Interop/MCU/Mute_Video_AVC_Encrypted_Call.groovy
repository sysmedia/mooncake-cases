...
/**
 * Created by Gary Wang on 2019-05-31.
 *
 #This case is to verify the scenario while MoonCake turn off its video in AVC Encrypted call
 ...
 */
class Mute_Video_AVC_Encrypted_Call extends MoonCakeSystemTestSpec {
    @Shared
    Dma dma
    ...
    def setupSpec() {
        moonCake.updateCallSettings(callRate, "on", true, false, true);
        moonCake111 = testContext.bookSut(MoonCake.class, "backup")
        moonCake111.updateCallSettings(callRate, "on", true, false, true);
        dma = testContext.bookSut(Dma.class, "AES")
    }
    ...
    def "Verify MoonCake joins encrypted VMR by H323, another MoonCake joins VMR by sip#"() {
        setup:
        moonCake.hangUp()
        moonCake111.hangUp()
        ...
        moonCake111.registerSip("TLS", true, "", dma.ip, moonsipUri, moonsipUri, "")
        pauseTest(5)
        ...
        verifyMediaStatistics(MediaChannelType.ARX, "--:--:--:--:0:true")
        verifyMediaStatistics(MediaChannelType.ATX, "--:--:--:--:0:true")
        verifyMediaStatistics(MediaChannelType.PVRX, "H.264High:--:--:--:--:true")
        verifyMediaStatistics(MediaChannelType.PVTX, "H.264High:--:--:--:--:true")

        verifyMediaStatistics(MediaChannelType.ARX, "--:--:--:--:0:true", moonCake111)
        verifyMediaStatistics(MediaChannelType.ATX, "--:--:--:--:0:true", moonCake111)
        verifyMediaStatistics(MediaChannelType.PVRX, "H.264High:--:--:--:--:true", moonCake111)
        verifyMediaStatistics(MediaChannelType.PVTX, "H.264High:--:--:--:--:true", moonCake111)
        ...
        verifyMediaStatistics(MediaChannelType.PVRX, "H.264High:--:--:--:--:true")
        verifyMediaStatistics(MediaChannelType.PVTX, "H.264High:--:--:--:--:true")
        verifyMediaStatistics(MediaChannelType.CVTX, "H.264:--:--:--:--:true")

        verifyMediaStatistics(MediaChannelType.ARX, "--:--:--:--:0:true", moonCake111)
        verifyMediaStatistics(MediaChannelType.ATX, "--:--:--:--:0:true", moonCake111)
        verifyMediaStatistics(MediaChannelType.PVRX, "H.264High:--:--:--:--:true", moonCake111)
        verifyMediaStatistics(MediaChannelType.PVTX, "H.264High:--:--:--:--:true", moonCake111)
        verifyMediaStatistics(MediaChannelType.CVRX, "H.264:--:--:--:--:true", moonCake111)
        ...
        verifyMediaStatistics(MediaChannelType.PVRX, "H.264High:--:--:--:--:true")
        verifyMediaStatistics(MediaChannelType.PVTX, "H.264High:--:--:--:--:true")
        verifyMediaStatistics(MediaChannelType.CVRX, "--:--:--:--:--:true")

        verifyMediaStatistics(MediaChannelType.ARX, "--:--:--:--:0:true", moonCake111)
        verifyMediaStatistics(MediaChannelType.ATX, "--:--:--:--:0:true", moonCake111)
        verifyMediaStatistics(MediaChannelType.PVRX, "H.264High:--:--:--:--:true", moonCake111)
        verifyMediaStatistics(MediaChannelType.PVTX, "H.264High:--:--:--:--:true", moonCake111)
        verifyMediaStatistics(MediaChannelType.CVTX, "H.264:--:--:--:--:true", moonCake111)
    ...
    def "Verify MoonCake joins encrypted VMR by SIP, another MoonCake joins VMR by H323"() {
        setup:
        moonCake.hangUp()
        moonCake111.hangUp()
        ...
        verifyMediaStatistics(MediaChannelType.PVRX, "H.264High:--:--:--:--:true")
        verifyMediaStatistics(MediaChannelType.PVTX, "H.264High:--:--:--:--:true")
        verifyMediaStatistics(MediaChannelType.CVRX, "--:--:--:--:1:true")

        verifyMediaStatistics(MediaChannelType.ARX, "--:--:--:--:0:true", moonCake111)
        verifyMediaStatistics(MediaChannelType.ATX, "--:--:--:--:0:true", moonCake111)
        verifyMediaStatistics(MediaChannelType.PVRX, "H.264High:--:--:--:--:true", moonCake111)
        verifyMediaStatistics(MediaChannelType.PVTX, "H.264High:--:--:--:--:true", moonCake111)
        verifyMediaStatistics(MediaChannelType.CVTX, "--:--:--:--:1:true", moonCake111)
