...
/**
 * Created by Sophia Song on 2019-04-26.
 * This case is to verify MoonCake calling MCU by H323 while call rate is 64k
 * Conference profile: Line rate 1024k + Encryption auto
 */
class AVC_64K_H323 extends MoonCakeSystemTestSpec {
    @Shared
    Dma dma
    ...
    @Shared
    String h323Name = "automooncake64"

    @Shared
    String e164Num = "843811064"
    ...
    def "Verify MoonCake Can Join The H323 Conference With Encryption Auto And DTMF #dtmf In Call Rate 64 Kbps"(String dialString,
                                                                                                                String dtmf,
                                                                                                                int callRate) {
