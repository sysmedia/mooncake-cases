 ...
 *
 * This case is to verify MoonCake calling MCU via VMR with call rate 4096K
 *
 ...
 */
class AVC_4096K_1080p_RMXVE extends MoonCakeSystemTestSpec{
    @Shared
    Dma dma
    ...
    def setupSpec() {
        ...
        dma.createVmr(vmrAVCAuto, callTmplAVCAuto, poolOrderRMXVE, dma.domain, dma.username, null, null)
    }
    def cleanupSpec() {
        dma.deleteVmr(vmrAVCAuto)
        dma.deleteConferenceTemplateByName(callTmplAVCAuto)
